...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 27 Avril 2017 à 13:35
...
(8, 'client@floris.com', '0a5e23db37d7f84372e717f851e822eb92aa770b0458734a45a7d8a4130fb1847f04a8ecf72b76bd1a571e2af1bbac2213217066fae31de0039d7645675240ed', 'TORABIAN', 'Fardad', '0606060606', 2, '2017-04-27 10:55:01');
...
--
ALTER TABLE `clients`
  MODIFY `clients_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pour la table `commandes`
--
ALTER TABLE `commandes`
  MODIFY `commandes_id` int(11) NOT NULL AUTO_INCREMENT;
--
